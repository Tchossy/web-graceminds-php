...
!(function (e, t) {
        ...
        return this.each(function () {
          ...
          if (
            ...
            i.windowListener === t &&
              ...
              'IE' !== window.RSBrowser &&
                /*! Custom Eases */
                ((tpGS.SFXBounceLite = tpGS.CustomBounce.create(
                  'SFXBounceLite',
        ...
        if (
          ...
          for (o = 0; o < i[a].middleZones[g].length; o++)
            i[a].middleZones[g][o].style.top =
              Math.round(b / 2 - i[a].middleZones[g][o].offsetHeight / 2) + 'px'
          ...
          if (i[o].layers[e.skey].hasOwnProperty(n)) {
            ...
            if ('preset' !== e.mode) {
              ...
              ;(1 == i[o].gridEQModule ||
                ...
                (D = void 0 !== c._lig ? c._lig.height() : i[o].ulh),
                (p = 0),
                (g = 0)),
                (y =
              ...
              if ('frame_0' !== L && 'frame_hover' !== L && 'loop' !== L) {
                ...
                if (
                  ...
                  if (
                    ((M.force3D = !0),
                    'block' === G.type &&
                      ((G.ft[0].background = A.sfx.fxc),
                      z.add(
                        tpGS.gsap.fromTo(G.bmask_in, P / 2, G.ft[0], G.ft[1], 0)
                      ),
                      z.add(
                        tpGS.gsap.fromTo(G.bmask_in, P / 2, G.ft[1], G.t, P / 2)
                      ),
                      'frame_0' === L || 'frame_1' === L
                        ? (N.opacity = 0)
                        : 'frame_999' === L &&
                    ...
                    for (var Q in t)
                      if (void 0 !== A[t[Q]] && !u.quickRendering) {
                        ...
                        delete X.dir,
                          ...
                          (X.stagger =
                            'center' === Z || 'edge' === Z
                              ? s({ each: Y, offset: Y / 2, from: Z })
                              : { each: Y, from: Z }),
                          (X.duration = P),
                          void 0 !== V && delete V.dir,
                          u.fff
                            ? z.add(C.fromTo(F, V, X), 0)
                            : z.add(C.to(F, X), 0),
                          (j = Math.max(j, F.length * Y))
                      }
                  ;(P += j),
                    u.pxundermask ||
                    (void 0 !== H &&
                      ...
                      ? (z.add(
                        ...
                        u.btrans &&
                          ...
                          (H.rotationX = u.btrans.rX),
                          (H.rotationY = u.btrans.rY),
                          (H.rotationZ = u.btrans.rZ),
                          (H.opacity = u.btrans.o)),
                        u.fff
                          ? z.add(
                              tpGS.gsap.fromTo(
                                [u.m, u.cbgmask],
                    ...
                    u.fff
                      ? ((M.visibility = 'visible'),
                        void 0 !== u.cbg && z.fromTo(u.cbg, P, N, M, 0),
                        i[p].BUG_safari_clipPath &&
                          (N.clipPath || M.clipPath || u.spike) &&
                          ((N.z && parseInt(N.z, 10)) || (N.z = -1e-4),
                          (M.z && parseInt(M.z, 10)) || (M.z = 0)),
                        void 0 !== u.cbg && 'column' === u.type
                          ? z.fromTo(O, P, r(N), r(M), 0)
                          : z.fromTo(O, P, N, M, 0))
                      : (void 0 !== u.cbg && z.to(u.cbg, P, M, 0),
                        !i[p].BUG_safari_clipPath ||
                          (!M.clipPath && !u.spike) ||
                          (M.z && parseInt(M.z, 10)) ||
          ...
          if (
            ...
            if (
              ...
              if (void 0 === u.childrenJS)
                for (var Q in ((u.childrenJS = {}), i[p]._L))
                  void 0 !== i[p]._L[Q]._lig &&
                    void 0 !== i[p]._L[Q]._lig[0] &&
                    i[p]._L[Q]._lig[0].id === a[0].id &&
                    i[p]._L[Q]._lig[0].id !== i[p]._L[Q].c[0].id &&
                    (u.childrenJS[i[p]._L[Q].c[0].id] = i[p]._L[Q].c)
              ...
              if (!0 === e.updateChildren)
                for (var Q in u.childrenJS)
                  u.childrenJS.hasOwnProperty(Q) &&
                    i.renderLayerAnimation({
        ...
        (e = e.split(';'))))
          if (e.hasOwnProperty(p)) {
            ...
            switch (g[0]) {
              ...
              case 'z':
                l.z =
                  'loop' === o ? parseInt(g[1], 0) : i.revToResp(g[1], i[t].rle)
                break
              case 'bow':
                l.borderWidth = i
                  .revToResp(g[1], 4, 0)
  ...
  (function (e) {
    ...
    var r = function (e, i) {
        ...
        o =
          (o = void 0 === (o = e.rtl ? t[i].slideamount - o : o) ? 0 : o) > 0 &&
          1 === t[i].sdir &&
          e.visibleAmount > 1
            ? o - 1
            : o
            ...
            swipeStatus: function (i, o, s, n, d, c, p) {
              ...
              switch (o) {
                ...
                case 'move':
                  if (L <= R) return !1
                  z =
                    (z = I + ('vertical' === T ? v : m)) > 0
                      ? 'horizontal' === T
                        ? z - S.width() * (((z / S.width()) * z) / S.width())
                        : z - S.height() * (((z / S.height()) * z) / S.height())
                      : z
                  var C =
                    'vertical' === T
                      ? 0 - (S.height() - k.height())
                  ...
                  ;(z =
                    z < C
                      ? 'horizontal' === T
                        ? z +
                          (((S.width() * (z - C)) / S.width()) * (z - C)) /
                            S.width()
                        : z +
                          (((S.height() * (z - C)) / S.height()) * (z - C)) /
                            S.height()
                      : z),
                    'vertical' === T
                      ? tpGS.gsap.set(S, { top: z + 'px' })
                      : tpGS.gsap.set(S, { left: z + 'px' }),
                    g(t[e].hideAllNavElementTimer)
                  break
                case 'end':
                case 'cancel':
                  ...
                  switch (
                    ...
                    case 'cancel':
                      clearTimeout(a.swipeMainTimer),
                        ...
                        clearTimeout(a.doubleCallToFinish),
                        (a.doubleCallToFinish = setTimeout(function () {
                          t.swipeAnimate({
                            id: e,
                            to: a.CACHE_slide_offset,
                            direction: n,
      ...
      a = function (e) {
        ...
        if (0 == d) {
              ...
              void 0 !== t[a].pr_next_bg &&
                ...
                t[a].mtl.add(
                  tpGS.gsap.fromTo(
                    t[a].pr_next_bg,
                    p / 1e3,
                    { autoAlpha: 0, filter: G, '-webkit-filter': G },
                    {
                      autoAlpha: 1,
                      filter: P,
                      '-webkit-filter': P,
                ...
                jQuery.inArray(l.trC, [6, 8, 10]) >= 0 &&
                  t[a].mtl.add(
                    tpGS.gsap.fromTo(
                      t[a].pr_active_bg,
                      p / 1e3,
                      { autoAlpha: 1, filter: P, '-webkit-filter': P },
                      {
                        autoAlpha: 0,
                        force3D: 'auto',
                        ease: m,
          ...
          var j = 3 == l.trC ? p / 1300 : p / 1e3,
            ...
            F = 4 == l.trC || 5 == l.trC ? 0.6 : 6 == l.trC ? 1.4 : 1,
            W = 5 == l.trC ? 1.4 : 6 == l.trC ? 0.6 : 1
          if (
            ((7 != l.trC && 4 != l.trC) || ((N = 0), (H = 0)),
            8 == l.trC
              ? (t[a].mtl.add(
          ...
          ;($[ne] = '0%'),
            ...
            t[a].mtl.add(tpGS.gsap.fromTo(V, p / 1e3, ae, re), 0),
            t[a].mtl.add(
              tpGS.gsap.fromTo(V.find('.slotslide div'), p / 1e3, oe, se),
              0
            )
        }
      },
